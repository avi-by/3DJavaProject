...
// The sphere encapsulates the view plane - all rays intersect with the sphere once
        ...
        for (int i = 0; i < HEIGHT; i++) {
            ...
            System.out.println("intersectionPointsSphere.size()\t"+intersectionPointsSphere.size());
            System.out.println("intersectionPointsSphere2.size()\t"+intersectionPointsSphere2.size());
